...
public class Node
{
	...
	public static void doInorderTraversal(Node node)
	{
		if(node.left != null)
		{
	...
	public static void doPostorderTraversal(Node node)
	{
		if(node.left != null)
		{
	...
	public static void main(String[] args)
	{
		...
		Node.doPreorderTraversal(root);
		System.out.print("\nIn order traversal : ");
		Node.doInorderTraversal(root);
		System.out.print("\nPost order traversal : ");
		Node.doPostorderTraversal(root);
